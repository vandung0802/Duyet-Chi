...
>
> **Cập nhật lần cuối:** phiên bản app **v95** (`APP_VERSION = '20260719-v95'`, sửa đăng nhập chậm 50s + nút GẤP bắt buộc lý do — mục AR). Trước đó **v94** (vá 2 lỗi Zalo — mục AQ), **v93** (tính năng GỬI ẢNH CHUYỂN TIỀN QUA ZALO — mục AP), **v92** (sửa lưu Ý KIẾN D/H trên phiếu ứng lương — mục AO), **v91** (màn "chờ duyệt" treo + nối lại listener — mục AN), **v87** (ứng lương = phiếu chi kind='salary' — mục AM), **v85** (`APP_VERSION = '20260714-v85'`, `sw.js VERSION = '20260714-85'`, `version.txt = 20260714-v85`) — thêm **module Lương/ứng lương** (mục AL). Trước đó: luật v83+v84 (mục AJ, AK) + backup tự động. Ngày 14/07/2026.
