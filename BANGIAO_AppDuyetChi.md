...
### BE. ✨ v107 — badge "Đã giục N lần" to gấp đôi + màu đỏ (31/07/2026)
User chốt: chữ "Đã giục" phải TO GẤP ĐÔI và màu ĐỎ. Badge đổi từ xanh 12px → nền đỏ nhạt `#fdecea`, chữ `#dc0000` đậm 900, **24px**; dòng giờ giục bên dưới cũng đỏ đậm. Vị trí: `_buildCard` khối `remindCount` (~dòng 3099). Đã test render: fontSize 24px, color rgb(220,0,0).
